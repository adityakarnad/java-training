 ...
 * 
 * THE USUAL WAY!
 * Methods of this class to be add(float a, float b), 
 ...
 * 
 * THE FUN WAY! (Why have 4 methods when just one can do?!)
 ...
 * 
 * - first and second are obviously the operands (or inputs)
